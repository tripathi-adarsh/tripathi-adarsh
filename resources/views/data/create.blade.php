...
<div class="row px-5">                 
    <div class="col-12 ">
        <div class="cust-container-desc-title float-left" style="margin-bottom: 0px;">
            <h3 class="cust-container-desc-title-h3 cus-school-teachers-head custom_teachers_count cus-font-family-lato ">
                <span  class="cus-admin-logo">Create Data</span>
            </h3>
        </div>                  
    </div>
    ...
    <div class="col-12 p-3">
        <!-- BEGIN OF FORM-->
        <form action="{{'/store-data'}}" class="form-horizontal text-margin-top" method="POST">
            @csrf
            <div class="form-body row">
                ...
                <label class="col-12 control-label cus-color-brown"><b>Name</b></label>
                    ...
                    @enderror
                        <input type="text" name="name"  class="form-control input-circle cust-grey-border-col" style="backgnameround:transparent; " placeholder="Name" value="{{ old('name') }}" required>
                    </div>
                </div>
